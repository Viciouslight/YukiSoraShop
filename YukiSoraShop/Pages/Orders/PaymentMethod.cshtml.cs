    ...
    public class OrdersPaymentMethodModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            if (EqualsName(SelectedMethod, "VNPay"))
            {
                ...
                return RedirectToPage("/Orders/Checkout", new { OrderId, Provider = "VNPay" });
            }
            if (EqualsName(SelectedMethod, "MoMo"))
            {
                _logger.LogInformation("Redirecting to Checkout (MoMo) for Order {OrderId}", OrderId);
                return RedirectToPage("/Orders/Checkout", new { OrderId, Provider = "MoMo" });
            }
